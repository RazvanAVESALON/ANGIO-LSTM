...
def main():
    ...
    csv_seq= pd.read_csv(r"D:\Angio\ANGIO-LSTM\Experimente\Experiment_Dice_index02012024_2116\Test02042024_1422\Statistics.csv")
    csv_rshp= pd.read_csv(r"D:\Angio\ANGIO-LSTM\Experimente\Experiment_Dice_index01282024_1514\Test02042024_1429\Statistics.csv")
    config = None
    with open("config.yaml") as f:
        config = yaml.safe_load(f)
    directory = f"Gif_overlap_Combined{datetime.now().strftime('%m%d%Y_%H%M')}"
    dir2="pred"
    parent_dir_seq = r"D:\Angio\ANGIO-LSTM\Experimente\Experiment_Dice_index02012024_2116\Test02042024_1422"
    parent_dir_rshp=   r"D:\Angio\ANGIO-LSTM\Experimente\Experiment_Dice_index01282024_1514\Test02042024_1429"
